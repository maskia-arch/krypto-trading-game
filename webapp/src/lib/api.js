...
export const api = {
  ...
  // Profil & Preise (Routen aus profile.js)
  ...
  // Trading & Charts (Routen aus trading.js & economy.js)
  ...
  // Economy & Assets (Routen aus economy.js)
  getLeaderboard:       () => apiCall('/api/leaderboard'), // Falls separat in server.js definiert
  ...
  // Hebel & Alerts (Routen aus economy.js)
